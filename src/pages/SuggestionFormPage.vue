                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" :class="{ 'is-invalid': errors.email }" id="email"
                                    placeholder="nome@mail.com" name="email" v-model.trim="form.email" required>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" :class="{ 'is-invalid': errors.subject }"
                                    id="subject" placeholder="" name="subject" v-model.trim="form.subject" required>
                                <div class="invalid-feedback">
                                    {{ errors.subject }}
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" :class="{ 'is-invalid': errors.message }" id="message"
                                    rows="3" name="message" v-model.trim="form.message" required>
                                                </textarea>
                                <div class="invalid-feedback">
                                    {{ errors.message }}
                                </div>
